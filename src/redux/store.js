...
let mdw = [api, rest, ...ui, ...route, ...cabecera, ...bonos, ...tipoComprobantes, ...documentacion, ...facturasPrestadores, ...facturasPrestadoresImagenes, ...facturasPrestadoresEstados,...autorizacion, ...prestador];
